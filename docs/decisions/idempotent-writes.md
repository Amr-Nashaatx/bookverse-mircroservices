...
<!--
Covers the whole decision, not four small ones: why a key at all, why it is
required, why it is scoped per user, why a unique constraint instead of a
lookup, and why the response is rebuilt rather than stored.
